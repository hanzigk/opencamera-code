...
class SpeechControl {
    ...
    private final ToastBoxer audio_fail_toast = new ToastBoxer();
            ...
            if( speechRecognizer != null ) {
                ...
                speechRecognizer.setRecognitionListener(new RecognitionListener() {
                    ...
                    public void onError(int error) {
                        ...
                        {
                            main_activity.preview.showToast(audio_fail_toast,"Can't get audio record permission");
                            Intent intent = new Intent().setClassName(main_activity,"com.example.audiocontrol.AudioControlService");
