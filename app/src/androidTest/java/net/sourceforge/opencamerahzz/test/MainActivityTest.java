package net.sourceforge.opencamerahzz.test;
...
import net.sourceforge.opencamerahzz.MyPreferenceFragment;
import net.sourceforge.opencamerahzz.PanoramaProcessorException;
import net.sourceforge.opencamerahzz.cameracontroller.CameraController2;
import net.sourceforge.opencamerahzz.HDRProcessor;
import net.sourceforge.opencamerahzz.HDRProcessorException;
...
import net.sourceforge.opencamerahzz.preview.ApplicationInterface;
import net.sourceforge.opencamerahzz.preview.VideoProfile;
import net.sourceforge.opencamerahzz.SaveLocationHistory;
import net.sourceforge.opencamerahzz.cameracontroller.CameraController;
import net.sourceforge.opencamerahzz.preview.Preview;
import net.sourceforge.opencamerahzz.ui.FolderChooserDialog;
import net.sourceforge.opencamerahzz.ui.PopupView;
...
public class MainActivityTest extends ActivityInstrumentationTestCase2<MainActivity> {
    ...
    private void switchToCamera(int cameraId) {
        ...
        while( newCameraId != cameraId ) {
            View switchCameraButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.switch_camera);
    ...
    private void switchToFlashValue(String required_flash_value) {
        if( mPreview.supportsFlash() ) {
            ...
            if( !flash_value.equals(required_flash_value) ) {
                ...
                View popupButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.popup);
    ...
    private void switchToISO(int required_iso) {
        ...
        if( iso != required_iso ) {
            ...
            View exposureButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.exposure);
            View exposureContainer = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.exposure_container);
    ...
    private void setToDefault() {
        ...
        if( mPreview.isVideo() ) {
            ...
            View switchVideoButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.switch_video);
    ...
    private void subTestSaveVideoMode() {
        ...
        View takePhotoButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.take_photo);
        View switchVideoButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.switch_video);

        assertTrue(!mPreview.isVideo());
        assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.take_photo) ) );
        assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.switch_to_video) ) );

        clickView(switchVideoButton);
        waitUntilCameraOpened();
        assertTrue(mPreview.isVideo());
        assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.start_video) ) );
        assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.switch_to_photo) ) );
    ...
    private void subTestExposureLockNotSaved() {
        ...
        View exposureLockButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.exposure_lock);
        assertTrue( exposureLockButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.exposure_lock) ) );
        clickView(exposureLockButton);
        assertTrue(mPreview.getCameraController().getAutoExposureLock());
        assertTrue( exposureLockButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.exposure_unlock) ) );
        ...
        restart();
        assertTrue(!mPreview.getCameraController().getAutoExposureLock());
        exposureLockButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.exposure_lock);
        assertTrue( exposureLockButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.exposure_lock) ) );
    }
    ...
    private void subTestWhiteBalanceLockNotSaved() {
        ...
        View whiteBalanceLockButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.white_balance_lock);
        ...
        assertTrue( whiteBalanceLockButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.white_balance_lock) ) );
        clickView(whiteBalanceLockButton);
        assertTrue(mPreview.getCameraController().getAutoWhiteBalanceLock());
        assertTrue( whiteBalanceLockButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.white_balance_unlock) ) );
        ...
        restart();
        assertTrue(!mPreview.getCameraController().getAutoWhiteBalanceLock());
        whiteBalanceLockButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.white_balance_lock);
        assertTrue( whiteBalanceLockButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.white_balance_lock) ) );
    }
    ...
    public void testFlashVideoMode() {
        ...
        restart();
        switchVideoButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.switch_video);
        assertTrue(mPreview.isVideo());
        assertTrue(mPreview.getCurrentFlashValue().equals("flash_off"));
    ...
    public void testFaceDetection() throws InterruptedException {
        ...
        View faceDetectionButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.face_detection);
        ...
        */
        ...
        assertTrue( faceDetectionButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.face_detection_disable) ) );
        ...
        restart();
        faceDetectionButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.face_detection);
        ...
        assertTrue( faceDetectionButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.face_detection_enable) ) );
    ...
    private void subTestPopupButtonContentDescription(int title_id, String test_key, boolean next, boolean expected) {
        ...
        if( button != null ) {
            ...
            String next_string = mActivity.getResources().getString(next ? net.sourceforge.opencamerahzz.R.string.next : net.sourceforge.opencamerahzz.R.string.previous);
    ...
    public void testSwitchVideo() {
        ...
        subTestPopupButtonContentDescription(net.sourceforge.opencamerahzz.R.string.preference_resolution, "PHOTO_RESOLUTIONS", false, true);
        subTestPopupButtonContentDescription(net.sourceforge.opencamerahzz.R.string.preference_resolution, "PHOTO_RESOLUTIONS", true, false);
        subTestPopupButtonContentDescription(net.sourceforge.opencamerahzz.R.string.preference_timer, "TIMER", false, false);
        subTestPopupButtonContentDescription(net.sourceforge.opencamerahzz.R.string.preference_timer, "TIMER", true, true);
        subTestPopupButtonContentDescription(net.sourceforge.opencamerahzz.R.string.preference_burst_mode, "REPEAT_MODE", false, false);
        subTestPopupButtonContentDescription(net.sourceforge.opencamerahzz.R.string.preference_burst_mode, "REPEAT_MODE", true, true);
        subTestPopupButtonContentDescription(net.sourceforge.opencamerahzz.R.string.grid, "GRID", false, true);
        subTestPopupButtonContentDescription(net.sourceforge.opencamerahzz.R.string.grid, "GRID", true, true);
        ...
        Log.d(TAG, "popup is now open");
        subTestPopupButtonContentDescription(net.sourceforge.opencamerahzz.R.string.video_quality, "VIDEO_RESOLUTIONS", false, true);
        subTestPopupButtonContentDescription(net.sourceforge.opencamerahzz.R.string.video_quality, "VIDEO_RESOLUTIONS", true, false);
        if( mActivity.getApplicationInterface().getSupportedVideoCaptureRates().size() > 1 ) {
            subTestPopupButtonContentDescription(net.sourceforge.opencamerahzz.R.string.preference_video_capture_rate, "VIDEOCAPTURERATE", false, false);
            subTestPopupButtonContentDescription(net.sourceforge.opencamerahzz.R.string.preference_video_capture_rate, "VIDEOCAPTURERATE", true, true);
        }
        subTestPopupButtonContentDescription(net.sourceforge.opencamerahzz.R.string.preference_timer, "TIMER", false, false);
        subTestPopupButtonContentDescription(net.sourceforge.opencamerahzz.R.string.preference_timer, "TIMER", true, true);
        subTestPopupButtonContentDescription(net.sourceforge.opencamerahzz.R.string.preference_burst_mode, "REPEAT_MODE", false, false);
    ...
    public void testTakePhotoExposureCompensation() throws InterruptedException {
        ...
        View exposureButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.exposure);
        View exposureContainer = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.exposure_container);
        SeekBar seekBar = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.exposure_seekbar);
    ...
    public void testTakePhotoManualISOExposure() throws InterruptedException {
        ...
        View exposureButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.exposure);
        View exposureContainer = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.manual_exposure_container);
        SeekBar isoSeekBar = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.iso_seekbar);
        SeekBar exposureTimeSeekBar = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.exposure_time_seekbar);
        assertTrue(exposureButton.getVisibility() == View.VISIBLE);
        assertTrue(exposureContainer.getVisibility() == View.GONE);
    ...
    public void testTakePhotoManualWB() throws InterruptedException {
        ...
        SeekBar white_balance_seek_bar = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.white_balance_seekbar);
        ...
        */
        ...
        View exposureContainer = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.exposure_container);
        SeekBar seekBar = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.exposure_seekbar);
        View manualWBContainer = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.manual_white_balance_container);
        SeekBar seekBarWB = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.white_balance_seekbar);
    ...
    public void testAudioControlIcon() {
        ...
        View audioControlButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.audio_control);
        ...
        audioControlButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.audio_control);
    ...
    private void waitForTakePhoto() {
        ...
        View audioControlButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.audio_control);
        View popupButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.popup);
        View trashButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.trash);
        View shareButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.share);
    ...
    public void testTakePhotoFrontCamera() throws InterruptedException {
        ...
        assertTrue(cameraId != new_cameraId);
        assertTrue( contentDescription.equals( mActivity.getResources().getString(new_is_front_facing ? net.sourceforge.opencamerahzz.R.string.switch_to_front_camera : net.sourceforge.opencamerahzz.R.string.switch_to_back_camera) ) );
        assertTrue( new_contentDescription.equals( mActivity.getResources().getString(is_front_facing ? net.sourceforge.opencamerahzz.R.string.switch_to_front_camera : net.sourceforge.opencamerahzz.R.string.switch_to_back_camera) ) );
        subTestTakePhoto(false, false, true, true, false, false, false, false);
        ...
        assertTrue( restart_contentDescription.equals( mActivity.getResources().getString(is_front_facing ? net.sourceforge.opencamerahzz.R.string.switch_to_front_camera : net.sourceforge.opencamerahzz.R.string.switch_to_back_camera) ) );
    ...
    public void testTakePhotoManualFocus() throws InterruptedException {
        ...
        SeekBar seekBar = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.focus_seekbar);
    ...
    public void testImmersiveMode() throws InterruptedException {
        ...
        View trashButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.trash);
        View shareButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.share);
        View zoomSeekBar = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.zoom_seekbar);
        View takePhotoButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.take_photo);
        View pauseVideoButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.pause_video);
        View takePhotoVideoButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.take_photo_when_video_recording);
        assertTrue(switchCameraButton.getVisibility() == View.VISIBLE);
        assertTrue(switchVideoButton.getVisibility() == View.VISIBLE);
        int exposureVisibility = exposureButton.getVisibility();
        int exposureLockVisibility = exposureLockButton.getVisibility();
    ...
    private int subTestTakeVideo(boolean test_exposure_lock, boolean test_focus_area, boolean allow_failure, boolean immersive_mode, VideoTestCallback test_cb, long time_ms, boolean max_filesize, boolean subtitles) throws InterruptedException {
        ...
        View switchVideoButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.switch_video);
        if( mPreview.isVideo() ) {
            assertTrue( (Integer)takePhotoButton.getTag() == net.sourceforge.opencamerahzz.R.drawable.take_video_selector );
            assertTrue( (Integer)switchVideoButton.getTag() == net.sourceforge.opencamerahzz.R.drawable.take_photo );
            assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.start_video) ) );
            assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.pause_video) ) );
            assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.switch_to_photo) ) );
        }
        else {
            assertTrue( (Integer)takePhotoButton.getTag() == net.sourceforge.opencamerahzz.R.drawable.take_photo_selector );
            assertTrue( (Integer)switchVideoButton.getTag() == net.sourceforge.opencamerahzz.R.drawable.take_video );
            assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.take_photo) ) );
            assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.pause_video) ) );
            assertTrue( switchVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.switch_to_video) ) );
        }
        ...
        if( mPreview.isVideoRecording() ) {
            assertTrue( (Integer)takePhotoButton.getTag() == net.sourceforge.opencamerahzz.R.drawable.take_video_recording );
            assertTrue( (Integer)switchVideoButton.getTag() == net.sourceforge.opencamerahzz.R.drawable.take_photo );
            assertTrue( takePhotoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.stop_video) ) );
            assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.pause_video) ) );
        ...
        assertTrue( (Integer)takePhotoButton.getTag() == net.sourceforge.opencamerahzz.R.drawable.take_video_selector );
        assertTrue( (Integer)switchVideoButton.getTag() == net.sourceforge.opencamerahzz.R.drawable.take_photo );
        assertEquals( takePhotoButton.getContentDescription(), mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.start_video) );
        assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.pause_video) ) );
    ...
    public void testTakeVideoPause() throws InterruptedException {
        ...
        final View pauseVideoButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.pause_video);
        assertTrue( pauseVideoButton.getVisibility() == View.GONE );
        ...
        subTestTakeVideo(false, false, false, false, new VideoTestCallback() {
            ...
            public int doTest() {
                ...
                assertTrue( pauseVideoButton.getContentDescription().equals( mActivity.getResources().getString(net.sourceforge.opencamerahzz.R.string.resume_video) ) );
                assertTrue( pauseVideoButton.getVisibility() == View.VISIBLE );
                assertTrue( mPreview.isVideoRecording() );
                assertTrue( mPreview.isVideoRecordingPaused() );
    ...
    private void subTestTakeVideoSnapshot() throws InterruptedException {
        ...
        final View takePhotoVideoButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.take_photo_when_video_recording);
        assertTrue( takePhotoVideoButton.getVisibility() == View.GONE );
    ...
    public void testTakeVideoSettings() throws InterruptedException {
        ...
        // now go to settings
        View settingsButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.settings);
    ...
    private void subTestTimer(int type) {
        ...
        try {
            ...
            takePhotoButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.take_photo);
    ...
    public void testPopupLeftLayout() {
        ...
        View popup_view = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.popup_container);
    ...
    public void testRightLayout() {
        ...
        View settingsButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.settings);
        View galleryButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.gallery);
    ...
    public void testPopupLayout() throws InterruptedException {
        ...
        for(int i=0;i<50;i++) {
            View popup_container = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.popup_container);
            View popupButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.popup);
            final float scale = mActivity.getResources().getDisplayMetrics().density;
    ...
    public void testZoom() throws InterruptedException {
        ...
        final ZoomControls zoomControls = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.zoom);
        assertTrue(zoomControls.getVisibility() == View.GONE);

        final SeekBar zoomSeekBar = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.zoom_seekbar);
        assertTrue(zoomSeekBar.getVisibility() == View.VISIBLE);
    ...
    private void setUpFocusBracketing() throws InterruptedException {
        SeekBar focusSeekBar = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.focus_seekbar);
        SeekBar focusTargetSeekBar = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.focus_bracketing_target_seekbar);
    ...
    private void subTestTakePhotoContinuousBurst(boolean is_slow) throws InterruptedException {
        ...
        final View takePhotoButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.take_photo);
        Log.d(TAG, "about to click take photo");
        mActivity.runOnUiThread(new Runnable() {
            public void run() {
    ...
    private void subTestTakePhotoPanorama(boolean to_max, boolean cancel, boolean cancel_by_settings) throws InterruptedException {
        ...
        View shareButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.share);
        View settingsButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.settings);
        View cancelPanoramaButton = mActivity.findViewById(net.sourceforge.opencamerahzz.R.id.cancel_panorama);
